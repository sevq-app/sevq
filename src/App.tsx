  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center gap-3 mb-2">
        <QLogo size={36} />
        <span className="font-heading font-extrabold text-xl text-sevchik-text">Севчик</span>
      </div>
      <div className="bg-white rounded-card p-5 flex flex-col items-center plastic-card" style={{ boxShadow: '0 8px 24px rgba(101,70,199,0.08)' }}>
        ...
        <p className="text-xs text-sevchik-textSecondary font-body mt-0.5 relative z-10">Твой маленький большой мир</p>
      ...
      <div className="bg-white rounded-card p-4 flex items-center gap-3 plastic-card" style={{ boxShadow: '0 8px 24px rgba(101,70,199,0.08)' }}>
        ...
        <div className="flex-1 min-w-0 relative z-10">
          <p className="text-sm font-heading font-bold text-sevchik-text truncate">Клуб путешественников</p>
          <p className="text-xs text-sevchik-textSecondary font-body">1.2k участников</p>
        </div>
      </div>
      <div className="bg-white rounded-card p-4 plastic-card" style={{ boxShadow: '0 8px 24px rgba(101,70,199,0.08)' }}>
        <h4 className="font-heading font-bold text-sm text-sevchik-text mb-3 relative z-10">Персональная тема</h4>
