  ...
  return (
    <div className="h-full overflow-y-auto pb-24 md:pb-6">
      ...
      <div className="px-4 sm:px-6 space-y-4 max-w-2xl mx-auto">
        ...
        <button onClick={() => onNavigate?.('about-edit')} className="w-full bg-[var(--bg-card)] rounded-2xl p-5 flex items-center justify-between text-left shadow-[0_8px_24px_rgba(101,70,199,0.08)]"><span className="font-heading font-bold">Укажите информацию о себе</span><ChevronRight size={20} className="text-sevchik-textSecondary" /></button>
