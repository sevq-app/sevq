    ...
    <div className="flex flex-col h-full bg-[var(--bg-main)]">
      <div className="px-4 sm:px-6 pt-4 pb-3 sticky top-0 z-20 bg-transparent">
        <div className="flex items-center justify-between mb-4">
          ...
          <div className="w-10 h-10 rounded-full bg-sevchik-orange flex items-center justify-center font-heading font-extrabold text-white text-sm" style={{ boxShadow: '0 2px 8px rgba(255,152,72,0.2)' }}>
            <span>АВ</span>
          </div>
        </div>
